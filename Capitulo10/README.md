# Configurar y validar servicios de sincronización horaria, registros del sistema.
...
|----------|----|----|-----------------|
| srv-linux-01 | Ubuntu 22.04.4 LTS | 192.168.100.10 | Servidor NTP, receptor syslog |
