...
Nota importante:  Este laboratorio no es realizable totalmente en Azure, solo podra hacerse en ambientes de hardware real o virtualizacion local de Linux usando Virtualbox o VMWare Workstation.
